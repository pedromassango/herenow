 ...
 */
class NearbyPlacesRepository(val nearbyPlacesLocalRepository: NearbyPlacesLocalRepository) : NearbyPlacesDataSource {
    ...
    override fun getNearbyPlaces(userLocation: LatLng, placeType: String,
        ...
        GetNearbyPlacesData(userLocation, placeType, object : NearbyPlacesDataSource.IRequestNearbyPlacesListener{
            override fun onSuccess(result: ArrayList<Place>) {
                ...
                nearbyPlacesLocalRepository.savePlaces( result)
